...
class FeatureDictTest(testing.FeatureExpectationsTestCase):
        ...
        self.assertFeature(
            feature=features_lib.FeaturesDict(
                {
                    ...
                    "img": {
                        "size": {"height": tf.int64, "width": tf.int64,},
            ...
            serialized_info={
                ...
                "img": {
                    ...
                    "metadata/path": features_lib.TensorInfo(shape=(), dtype=tf.string),
                },
            },
            dtype={
                "input": tf.int64,
            ...
            shape={
                "input": (),
                "output": (),
                "img": {"size": {"height": (), "width": (),}, "metadata/path": (),},
            },
            tests=[
                # Np array
    ...
    def test_feature_getitem(self):
        fdict = features_lib.FeaturesDict({"integer": tf.int32, "string": tf.string,})
...
class FeatureTensorTest(testing.FeatureExpectationsTestCase):
    def test_shape_static(self):
        ...
        self.assertFeature(
            ...
            tests=[
                # Np array
                testing.FeatureExpectationItem(value=np_input, expected=np_input,),
                # Python array
                testing.FeatureExpectationItem(
                    value=array_input, expected=array_input,
                ),
                # Invalid dtype
                testing.FeatureExpectationItem(
    ...
    def test_shape_dynamic(self):
        ...
        self.assertFeature(
            ...
            tests=[
                testing.FeatureExpectationItem(
                    value=np_input_dynamic_1, expected=np_input_dynamic_1,
                ),
                testing.FeatureExpectationItem(
                    value=np_input_dynamic_2, expected=np_input_dynamic_2,
                ),
                # Invalid shape
                testing.FeatureExpectationItem(
    ...
    def test_bool_flat(self):
        ...
        self.assertFeature(
            ...
            shape=(),
            tests=[
                testing.FeatureExpectationItem(value=np.array(True), expected=True,),
                testing.FeatureExpectationItem(value=np.array(False), expected=False,),
                testing.FeatureExpectationItem(value=True, expected=True,),
                testing.FeatureExpectationItem(value=False, expected=False,),
            ],
        )
    ...
    def test_bool_array(self):
        ...
        self.assertFeature(
            ...
            tests=[
                testing.FeatureExpectationItem(
                    value=np.array([True, True, False]), expected=[True, True, False],
                ),
                testing.FeatureExpectationItem(
                    value=[True, False, True], expected=[True, False, True],
                ),
            ],
        )
    ...
    def test_string(self):
        ...
        self.assertFeature(
            ...
            tests=[
                # Non-unicode
                testing.FeatureExpectationItem(
                    value=nonunicode_text, expected=tf.compat.as_bytes(nonunicode_text),
                ),
                # Unicode
                testing.FeatureExpectationItem(
                    value=unicode_text, expected=tf.compat.as_bytes(unicode_text),
                ),
                # Empty string
                testing.FeatureExpectationItem(value="", expected=b"",),
                # Trailing zeros
                testing.FeatureExpectationItem(
                    value=b"abc\x00\x00", expected=b"abc\x00\x00",
                ),
            ],
        )
