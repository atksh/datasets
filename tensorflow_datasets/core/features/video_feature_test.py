...
class VideoFeatureTest(testing.FeatureExpectationsTestCase):
    ...
    def test_video_numpy(self):
        ...
        self.assertFeature(
            ...
            shape=(None, 64, 64, 3),
            dtype=tf.uint8,
            tests=[testing.FeatureExpectationItem(value=np_video, expected=np_video,),],
        )
    ...
    def test_video_concatenated_frames(self):
        ...
        frames_paths = [
            os.path.join(lsun_examples_path, "{}.jpg".format(i)) for i in (1, 2, 3, 4)
        ]
        frames = []
        ...
        self.assertFeature(
            ...
            tests=[
                # Numpy array
                testing.FeatureExpectationItem(value=frames_paths, expected=video,),
            ],
        )
    ...
    def test_video_ffmpeg(self):
        ...
        self.assertFeature(
            ...
            dtype=tf.uint8,
            tests=[
                testing.FeatureExpectationItem(value=video_path, expected=video_array,),
            ],
        )
            ...
            self.assertFeature(
                ...
                tests=[
                    testing.FeatureExpectationItem(
                        value=video_fp, expected=video_array,
                    ),
                ],
            )
