...
class ImageFeatureTest(testing.FeatureExpectationsTestCase, parameterized.TestCase):
    ...
    def test_images(self, dtype):
        ...
        self.assertFeature(
            ...
            tests=[
                # Numpy array
                testing.FeatureExpectationItem(value=img, expected=img,),
                # File path
                testing.FeatureExpectationItem(
                    value=img_file_path, expected=img_file_expected_content,
                ),
                # 'img' shape can be dynamic
                testing.FeatureExpectationItem(
                    value=img_other_shape, expected=img_other_shape,
                ),
                # Invalid type
                testing.FeatureExpectationItem(
    ...
    def test_image_shaped(self):
        ...
        self.assertFeature(
            ...
            dtype=tf.uint8,
            tests=[
                testing.FeatureExpectationItem(value=img_shaped, expected=img_shaped,),
