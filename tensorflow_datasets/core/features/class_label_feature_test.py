...
class ClassLabelFeatureTest(testing.FeatureExpectationsTestCase):
    def test_feature(self):
        self.assertFeature(
            ...
            shape=(),
            tests=[
                testing.FeatureExpectationItem(value=3, expected=3,),
                testing.FeatureExpectationItem(value="3", expected=3,),
                ...
                testing.FeatureExpectationItem(
                    value="10", raise_cls=ValueError, raise_msg="Invalid",
                ),
            ],
        )
    ...
    def test_labels(self):
        ...
        self.assertFeature(
            ...
            shape=(),
            tests=[
                testing.FeatureExpectationItem(value=1, expected=1,),
                testing.FeatureExpectationItem(value="left", expected=0,),
                testing.FeatureExpectationItem(value="right", expected=1,),
            ],
        )
    ...
    def test_str_classes(self):
        ...
        self.assertEqual(labels.names, ["label3", "label1", "label2",])
    ...
    def test_save_load(self):
        ...
        self.assertEqual(labels2.names, ["label3", "label1", "label2",])
