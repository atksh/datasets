    ...
    def _split_generators(self, dl_manager):
        return [
            splits.SplitGenerator(
                name=splits.Split.TRAIN, num_shards=2, gen_kwargs={"range_": range(20)}
            ),
            splits.SplitGenerator(
    ...
    def _info(self):
        return dataset_info.DatasetInfo(
            ...
            features=features.FeaturesDict(
                {"x": tf.int64, "y": tf.int64, "z": tf.string,}
            ),
        )
...
class TFRecordUtilsTest(testing.SubTestCase):
    def test_dict_to_example(self):
        ...
        self.assertEqual(
            [b"\x00\x00", b"\x00\x00"], list(feature["e2"].bytes_list.value)
        )
        ...
        self.assertFeature(
            ...
            tests=[
                ...
                testing.FeatureExpectationItem(
                    value={"str": "", "int": 1, "bool": [True], "float": [[2.0, 3.0]],},
                    expected={
                        "str": b"",
                        "int": 1,
                        "bool": [True],
    ...
    def test_features_sequence(self):
        ...
        self.assertFeature(
            specs={
                "a": {"b": features.TensorInfo(shape=(None,), dtype=tf.string),},
            ...
            tests=[
                # Raw values
                testing.FeatureExpectationItem(
                    value={"a": {"b": [],}, "a/c": [[1, 2], [3, 4]],},
                    expected={"a": {"b": [],}, "a/c": [[1, 2], [3, 4]],},
                    expected_serialized={
    ...
    def test_default_value(self):
        ...
        self.assertEqual(
            example,
            {"image/encoded": b"hello world", "image/height": -1, "image/width": -1,},
        )
