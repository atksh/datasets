...
class DatasetAsNumPyTest(testing.TestCase):
    ...
    def test_tensors_match(self):
        t = tf.random.uniform(shape=(50, 3), maxval=1000, dtype=tf.int32,)
    ...
    def test_ragged_tensors(self):
        ...
        self.assertAllEqual(rt, tf.ragged.constant([[1, 2, 3], [], [4, 5],]))
    ...
    def test_ragged_tensors_ds(self):
        ...
        self.assertAllEqual(rt0, [[0, 1, 2], [], [3,],])
...
class DatasetOffsetTest(testing.TestCase):
    ...
    def test_no_examples_skipped(self):
        ...
        self.assertTrue(
            dataset_utils._no_examples_skipped(
                [
                    {"filepath": "some_path", "mask_offset": 5, "mask": [True] * 100,},
                    {"filepath": "some_path", "mask_offset": 60, "mask": [True] * 100,},
                    {"filepath": "some_path", "mask_offset": 0, "mask": [True] * 100,},
                ]
            )
        )
        self.assertFalse(
