...
class CelebA(tfds.core.GeneratorBasedBuilder):
    ...
    VERSION = tfds.core.Version("0.3.0", experiments={tfds.core.Experiment.S3: False})
    SUPPORTED_VERSIONS = [
        tfds.core.Version(
    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            tfds.core.SplitGenerator(
                ...
                num_shards=10,
                gen_kwargs={"file_id": 0, "extracted_dirs": extracted_dirs,},
            ),
            tfds.core.SplitGenerator(
                name=tfds.Split.VALIDATION,
                num_shards=4,
                gen_kwargs={"file_id": 1, "extracted_dirs": extracted_dirs,},
            ),
            tfds.core.SplitGenerator(
                name=tfds.Split.TEST,
                num_shards=4,
                gen_kwargs={"file_id": 2, "extracted_dirs": extracted_dirs,},
            ),
        ]
    ...
    def _generate_examples(self, file_id, extracted_dirs):
        """Yields examples."""
        filedir = os.path.join(extracted_dirs["img_align_celeba"], "img_align_celeba")
