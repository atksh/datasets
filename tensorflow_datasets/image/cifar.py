...
class Cifar10(tfds.core.GeneratorBasedBuilder):
    ...
    VERSION = tfds.core.Version("1.0.2", experiments={tfds.core.Experiment.S3: False})
    SUPPORTED_VERSIONS = [
        tfds.core.Version(
...
class Cifar100(Cifar10):
    ...
    VERSION = tfds.core.Version("1.3.1", experiments={tfds.core.Experiment.S3: False})
    SUPPORTED_VERSIONS = [
        tfds.core.Version(
            "3.0.0", "New split API (https://tensorflow.org/datasets/splits)"
        ),
    ...
    def _info(self):
        return tfds.core.DatasetInfo(
            builder=self,
            description=(
                "This dataset is just like the CIFAR-10, except it has "
