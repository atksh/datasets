...
def _process_image_file(fobj, session, filename, quality=None, target_pixels=None):
...
class Sun397Config(tfds.core.BuilderConfig):
    ...
    def __init__(self, target_pixels=None, partition=None, quality=None, **kwargs):
...
class Sun397(tfds.core.GeneratorBasedBuilder):
    ...
    def _info(self):
        names_file = tfds.core.get_tfds_path(os.path.join("image", "sun397_labels.txt"))
