    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            tfds.core.SplitGenerator(
                ...
                num_shards=1,
                gen_kwargs={"images_dir_path": os.path.join(path, "sample"),},
            ),
            tfds.core.SplitGenerator(
                name="train",
                num_shards=100,
...
def _btgraham_processing(image_fobj, filepath, target_pixels, crop_to_radius=False):
