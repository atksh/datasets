...
_DATASET_URL = (
    "https://drive.google.com/uc?export=download&id=0B7OEHD3T4eCkVGs0TkhUWFN6N1k"
)
            ...
            features=tfds.features.FeaturesDict(
                {
                    ...
                    "tex_params": tfds.features.Tensor(shape=(199,), dtype=tf.float32),
                    "shape_params": tfds.features.Tensor(
                        shape=(199,), dtype=tf.float32
                    ),
                    "exp_params": tfds.features.Tensor(shape=(29,), dtype=tf.float32),
                    "pose_params": tfds.features.Tensor(shape=(7,), dtype=tf.float32),
                }
            ),
    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            tfds.core.SplitGenerator(
                ...
                gen_kwargs={"image_dir_path": os.path.join(extracted_path, "300W_LP"),},
            ),
        ]
