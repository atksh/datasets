...
class LibrispeechConfig(tfds.core.BuilderConfig):
    ...
    """
        ...
        if description is None:
            ...
            if data == "all":
                ...
                data_description = (
                    "Uses only clean data,%s including train-clean-360."
    ...
    def download_urls(self):
        ...
        urls = {
            split: [_DL_URLS[name] for name in names] for split, names in urls.items()
        }
        return urls
    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            tfds.core.SplitGenerator(
                ...
                num_shards=100,
                gen_kwargs={"dirs": extracted_dirs[tfds.Split.TRAIN],},
            ),
            tfds.core.SplitGenerator(
                name=tfds.Split.VALIDATION,
                num_shards=10,
                gen_kwargs={"dirs": extracted_dirs[tfds.Split.VALIDATION],},
            ),
            tfds.core.SplitGenerator(
                name=tfds.Split.TEST,
                num_shards=10,
                gen_kwargs={"dirs": extracted_dirs[tfds.Split.TEST],},
            ),
        ]
...
LibrispeechExample = collections.namedtuple(
    "_LibrispeechExample", ["speaker_id", "chapter_id", "audio_file", "transcript"]
)
