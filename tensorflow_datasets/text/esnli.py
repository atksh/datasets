    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            tfds.core.SplitGenerator(
                name=tfds.Split.TRAIN, gen_kwargs={"files": files["train"]},
            ),
            tfds.core.SplitGenerator(
                name=tfds.Split.VALIDATION, gen_kwargs={"files": files["validation"]},
            ),
            tfds.core.SplitGenerator(
                name=tfds.Split.TEST, gen_kwargs={"files": files["test"]},
            ),
        ]
