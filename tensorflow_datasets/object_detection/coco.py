...
class CocoConfig(tfds.core.BuilderConfig):
    ...
    def __init__(self, splits=None, has_panoptic=False, **kwargs):
        super(CocoConfig, self).__init__(version=tfds.core.Version("1.1.0"), **kwargs)
        self.splits = splits
...
class Coco(tfds.core.GeneratorBasedBuilder):
    ...
    def _generate_examples(
        self, image_dir, annotation_dir, split_name, annotation_type, panoptic_dir
    ):
    ...
    """
        ...
        instance_path = os.path.join(
            annotation_dir, "annotations", instance_filename.format(split_name),
        )
