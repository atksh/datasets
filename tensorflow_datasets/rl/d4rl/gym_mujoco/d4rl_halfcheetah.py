...
from tensorflow_datasets.rl.d4rl import dataset_utils
...
class D4rlHalfcheetah(tfds.core.GeneratorBasedBuilder):
        ...
        features=tfds.features.FeaturesDict({
            'steps':
                tfds.features.Dataset({
                    'observation':
                        tfds.features.Tensor(shape=(17,), dtype=tf.float32),
                    'action':
